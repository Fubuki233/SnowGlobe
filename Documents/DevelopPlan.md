...
| 角色 | 任务 | 交付物 |
|------|------|--------|
| zyh | GOAP，搭建测试场景 | 可运行的GOAP Demo |
| myy | 物品模板系统设计(可以被外部python脚本操作,最好可以在游戏运行时注册新物品) | 可点击地图放置物品 |
| mzt | 基础网格系统(现在已有tilemaplayer的网格,现在需要每个网格内的贴图/属性都可以被python脚本操作)| 网格系统代码|
| 美术 | 手绘几个场景元素 | 房屋/树木/地形/人造物之类的 |
| 策划 | 居民属性+计算方法 + 10个物品设计表(最好是类似科技树里面的物品,各自有关联) | Excel文档 |
